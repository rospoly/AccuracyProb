...
\begin{figure}[h!]
\hspace{-1ex}\includegraphics[scale=0.60]{several_examples}
...
\begin{figure}[ht!]
\includegraphics[scale=0.55]{typical_dist}
...
\begin{figure}[h!]
\includegraphics[scale=0.22]{Relative_Error_Distribution}
...
\begin{figure}[h!]
\includegraphics[scale=0.22]{range_dist_div}
...
\begin{figure}[h!]
	\includegraphics[scale=0.22]{range_dist}
...
\begin{figure}[h!]
	\includegraphics[scale=0.177]{mul}
...
\bibliography{constantinides-dahlqvist}
